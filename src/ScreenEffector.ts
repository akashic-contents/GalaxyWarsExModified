export interface ScreenEffectorParameterObject extends g.EParameterObject {
    mosaicLevel: number;
}

export class ScreenEffector extends g.E {
    private backSurface: g.Surface;
    private backRenderer: g.Renderer;
    private filterSurface: g.Surface;
    private filterRenderer: g.Renderer;
    private blurEffect;
    private cntr: number;
    mosaicLevel: number;

    constructor(params: ScreenEffectorParameterObject) {
        super(params);
